...
class Concate_fusion():
    def __init__(self, flag_cuda, learning_rate, weight_decay, train_loader, val_loader, test_loader, followbase_loader, unhealthy_loader, followup_loader, type, Extra, Data_Aug, loss):
    ...
    def process(self, Iter=200):
        doc_type = 'post_fusion' + self.type + '_' + self.Extra + '_' + self.Data_Aug + '_' + str(self.wd) + '_' + self.loss
