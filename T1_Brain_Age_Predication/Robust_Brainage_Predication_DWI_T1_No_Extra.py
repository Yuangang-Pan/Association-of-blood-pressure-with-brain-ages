...
if type == 'T1':
    Y_train, Y_val, Y_test, Y_Followbase, Y_Unhealthy, Y_Followup = T1_supervision_load(isGadi, Y_test, split)
        ...
        for id2 in range((len(Extra))):
            for id3 in range(len(weight_decay)):
                for id4 in range(len(Loss)):
                    ...
                    print('Data_type:', type, ' Data:', doc[idx], ' Data Augmentation ', Data_Aug[id1], ' Use ', Extra[id2],
                    ' Weight Decay:', weight_decay[id3], ' Loss:', Loss[id4])
